...
export default function Chart1Overlays(props) {
  let { dataTheme, chart3IndicatorValue, seriesPropertiesMenuOpenHandler } =
    props;
    ...
    <Fragment>
      <Box sx={CHART_3_OVERLAYS_SX}>
        <Box sx={LEGEND_FLEXBOX_SX}>
          ...
          {chart3IndicatorValue && legendVisible && (
            <Tooltip
              title={chart3IndicatorValue + " settings"}
              placement={"right"}
            >
              <Card
                onClick={() => {
