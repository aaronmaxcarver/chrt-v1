//-- AWS SDK --//
import { DynamoDBClient as DynamoDBClient_ } from "@aws-sdk/client-dynamodb";
...
export function freshIDToken_DynamoDBClient(newIDToken) {
...
//-- DynamoDB SDK Client --//
const DynamoDBClient = new DynamoDBClient_({
  region: REGION,
